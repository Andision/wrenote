...
def _text_lang_override(text: str, audio_lang: str, tgt_lang: str) -> str:
    ...
    if tgt_lang == "zh" and cjk > 0 and hira == 0 and kata == 0 and hangul == 0:
        if cjk / total >= 0.4:
            return "zh"
    ...
    async def _partial_loop(
        ...
        try:
            while True:
                ...
                effective_src = _text_lang_override(
